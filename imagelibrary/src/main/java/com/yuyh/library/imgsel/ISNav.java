...
public class ISNav {
    ...
    public void toList(AppCompatActivity activity , ISListConfig config, int reqCode) {
            ISListActivity.startForResult(activity, config, reqCode);
    ...
    public void toCamera(Object source, ISCameraConfig config, int reqCode) {
        if (source instanceof Activity) {
